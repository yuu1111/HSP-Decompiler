...
namespace KttK.HspDecompiler.Ax3ToAs.Data
{
    ...
    internal sealed class AxHeader
    {
        ...
        {
            get { return data[5] / (int)HeaderDataSize.Code; }
        }

        internal uint CodeEnd
        {
            get { return CodeStart + CodeSize; }
        }
        ...
        {
            get { return LiteralStart + LiteralSize; }
        }
        ...
        {
            get { return data[9] / (int)HeaderDataSize.Label; }
        }

        internal uint LabelEnd
        {
            get { return LabelStart + LabelSize; }
        }
        ...
        {
            get { return DebugStart + DebugSize; }
        }
        ...
        {
            get { return data[13] / (int)HeaderDataSize.Dll; }
        }

        internal uint DllEnd
        {
            get { return DllStart + DllSize; }
        }
        ...
        {
            get { return data[15] / (int)HeaderDataSize.Function; }
        }

        internal uint FunctionEnd
        {
            get { return FunctionStart + FunctionSize; }
        }
        ...
        {
            get { return data[17] / (int)HeaderDataSize.Parameter; }
        }

        internal uint ParameterEnd
        {
            get { return ParameterStart + ParameterSize; }
        }
...
//		internal uint End { get { return Start + Size; } }
        ...
        {
            get { return data[21] / (int)HeaderDataSize.Plugin; }
        }
        ...
        {
            get { return PluginStart + PluginSize; }
        }
